...
export const SidebarComp = ({
  ...
  return (
    <aside
      ...
      className={cn(
        expanded
          ? 'flex flex-col w-[500px] h-screen px-8 py-4 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700'
    ...
    >
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <DfxMenuList library={libraryType} showText={expanded} variant='basic' menuArrays={menuArrays} type={menuType} />
